...
variable "bootstrap_runtime_service_account_email" {
  ...
  type        = string
  default     = "cloud-run-bootstrap@__PROJECT_ID__.iam.gserviceaccount.com"
}
...
variable "prod_publisher_service_account_email" {
  ...
  type        = string
  default     = "gha-prod-publish@__PROJECT_ID__.iam.gserviceaccount.com"
}

variable "deployment_parity_reader_service_account_email" {
  description = "Read-only deployment parity service account email."
  type        = string
  default     = "gha-deploy-parity@__PROJECT_ID__.iam.gserviceaccount.com"
}
...
variable "preview_commit_service_account_email" {
  ...
  type        = string
  default     = "gha-preview-commit@__PROJECT_ID__.iam.gserviceaccount.com"
}
...
variable "preview_publisher_service_account_email" {
  ...
  type        = string
  default     = "gha-preview-publish@__PROJECT_ID__.iam.gserviceaccount.com"
}
