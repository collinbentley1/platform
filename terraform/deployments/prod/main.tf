...
locals {
  ...
  deployments = {
    "1255553151" = {
      ...
      deployment_parity_reader_service_account = "gha-deploy-parity@cdbentley.iam.gserviceaccount.com"
    ...
    "711292980" = {
      ...
      deployment_parity_reader_service_account = "gha-deploy-parity@runsetta.iam.gserviceaccount.com"
      preview_deploy_service_account           = "gha-preview-deploy@runsetta.iam.gserviceaccount.com"
      preview_commit_service_account           = "gha-preview-commit@runsetta.iam.gserviceaccount.com"
    ...
    "1025243085" = {
      ...
      deployment_parity_reader_service_account = "gha-deploy-parity@medlock-1025243085.iam.gserviceaccount.com"
      preview_deploy_service_account           = "gha-preview-deploy@medlock-1025243085.iam.gserviceaccount.com"
      preview_commit_service_account           = "gha-preview-commit@medlock-1025243085.iam.gserviceaccount.com"
    ...
    "280932482" = {
      ...
      deployment_parity_reader_service_account = "gha-deploy-parity@critical-history-16823277.iam.gserviceaccount.com"
      preview_deploy_service_account           = "gha-preview-deploy@critical-history-16823277.iam.gserviceaccount.com"
      preview_commit_service_account           = "gha-preview-commit@critical-history-16823277.iam.gserviceaccount.com"
...
module "site" {
  ...
  deployment_parity_reader_service_account_email = local.deployment.deployment_parity_reader_service_account
