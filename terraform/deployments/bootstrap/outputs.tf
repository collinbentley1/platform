...
output "bootstrap_state_bucket_name" {
  description = "Separately protected privileged bootstrap state bucket."
...
output "terraform_service_account_email" {
  description = "Metadata-only service account used by the immutable production convergence workflow."
...
output "runtime_service_account_email" {
  description = "Cloud Run production runtime service account."
  value       = module.bootstrap.runtime_service_account_email
}

output "preview_runtime_service_account_email" {
  description = "No-data Cloud Run preview runtime service account."
  value       = module.bootstrap.preview_runtime_service_account_email
}
